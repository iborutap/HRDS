...
import { addData, updateData } from '../services/Sheethrds';

const PersonForm = ({ onSubmit, onCancel, initialData }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm()) {
      onSubmit(formData);
      try {
        const addedPerson = await addData(formData);
        if (addedPerson) {
  ...
  const handleUpdate = async (e) => {
    ...
    if (validateForm()) {
      onSubmit(formData);
      try {
        const updatedPerson = await updateData(formData.id, formData);
        if (updatedPerson) {
  ...
  return (
    <div className="bg-white/60 backdrop-blur-sm rounded-xl border border-white/20 p-8">
      ...
      <form onSubmit={initialData ? handleUpdate : handleSubmit} className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 ${errors.fullName ? 'border-red-300' : 'border-gray-300'
                }`}
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 ${errors.populationId ? 'border-red-300' : 'border-gray-300'
                }`}
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 ${errors.familyId ? 'border-red-300' : 'border-gray-300'
                }`}
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 ${errors.dateOfBirth ? 'border-red-300' : 'border-gray-300'
                }`}
            />
            {errors.dateOfBirth && (
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 ${errors.placeOfBirth ? 'border-red-300' : 'border-gray-300'
                }`}
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 ${errors.religion ? 'border-red-300' : 'border-gray-300'
                }`}
